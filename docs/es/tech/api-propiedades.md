...
No forman parte del repositorio de propiedades pero se usan en el flujo de visitas. Véase [API — Visitas](api-visits).

## Temas relacionados

- [Esquema de base de datos](db-schema) — `properties` y tablas relacionadas
- [Conceptos](concepts) — Propiedades
- [API — Visitas](api-visits)
