...
Véase [Esquema de base de datos](db-schema).
...
- **Condiciones estructuradas y VPN**: Modelo explícito para condiciones de oferta y cálculo de valor.
- **Compatibilidad hacia atrás**: Estrategia de migración y feature flags para cambios críticos.
...
- [Instalación](installation) — Configuración del entorno
- [Conceptos](concepts) — Modelo de dominio
- [Despliegue](deployment) — Build y producción
