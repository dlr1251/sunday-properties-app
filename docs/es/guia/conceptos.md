...
- [Arquitectura](arquitectura) — Stack técnico y diseño
- [Base de datos — Esquema](../referencia/base-de-datos/esquema) — Tablas y relaciones
- [Negociación](../procesos/negociacion) — Flujo de ofertas y cierre
