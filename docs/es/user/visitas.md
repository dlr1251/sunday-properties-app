...
- Navegar por meses. Solo se pueden elegir fechas disponibles (según disponibilidad y fechas bloqueadas).
...
Recibir confirmación por correo y en la plataforma. La visita aparece en "Mis visitas" con estado "pendiente" hasta que el vendedor confirme.

### 6. Asistir y feedback

Acudir en la fecha y hora acordadas. Tras la visita, se puede enviar feedback y valoración.
...
- [Reagendar visitas](reagendar-visitas) — Cambiar o cancelar una visita
- [Hacer una oferta](hacer-oferta) — Ofertas tras la visita
