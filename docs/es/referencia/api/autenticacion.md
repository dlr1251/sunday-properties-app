...
- [Base de datos — Esquema](../base-de-datos/esquema) — Tabla `profiles`
- [Base de datos — Políticas RLS](../base-de-datos/politicas-rls) — Acceso a `profiles`
- [Conceptos](../../guia/conceptos) — Usuarios y roles
