...
Condiciones estructuradas por oferta: tipo, valor, impacto en VPN, estado (`proposed`, `accepted`, `rejected`, `countered`, `withdrawn`). Ver [ADR-001](../../decisiones/adr-001-condiciones-estructuradas).
...
Tipos de condición típicos: `inspection_contingency`, `financing_contingency`, `notary_costs`, etc. Véase el esquema y los ADR.

## Cálculo de VPN

El cálculo de VPN (NPV) se implementa en servicios y/o funciones SQL. Los resultados se persisten en `offers` (`calculated_npv`, `risk_adjusted_npv`, `npv_breakdown`). Ver [ADR-002](../../decisiones/adr-002-calculo-vpn) y [Base de datos — Funciones](../base-de-datos/funciones).

## Temas relacionados

- [Base de datos — Esquema](../base-de-datos/esquema) — `offers`, `counter_offers`, `offer_conditions`
- [Procesos — Negociación](../../procesos/negociacion)
- [ADR-001 — Condiciones estructuradas](../../decisiones/adr-001-condiciones-estructuradas)
