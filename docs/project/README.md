...
| [demo-prep.md](./demo-prep.md) | Guía para preparar demos |
| [real-properties.md](./real-properties.md) | Propiedades reales y SEO arriendos |
...
### Notion (Gestión del Proyecto — Teamspace Sunday Properties)

- [🛠️ Plataforma Sunday — Desarrollo](https://www.notion.so/386a689f0025814c995ee90ebd85f815) — Hub principal de desarrollo
- [Tareas — Desarrollo](https://www.notion.so/34f44b526fa849eeac4649be8540d9d4) — Backlog y trabajo activo
- [Roadmap — Fases & Hitos](https://www.notion.so/4e6a6c88769349c2be3eb8a1433c1682) — Planificación por fases
- [Bitácora / Changelog](https://www.notion.so/a1ffb97bdb4346eb834b593701efd4c9) — Registro de avances
- [📚 Documentación (espejo Notion)](https://www.notion.so/386a689f002581b69441c5ce00d1b9ff) — Mirror bilingüe de `docs/en` y `docs/es`

**Sincronización docs → Notion:** `npm run sync:docs-notion` (requiere `NOTION_TOKEN` en `.env.local`; ver `.env.example`)

### Notion (Lógica de Negocio — legado)

Los enlaces anteriores apuntaban a otro workspace. La gestión de desarrollo vive ahora en el teamspace **Sunday Properties** (enlaces arriba). Para estrategia de marca y operaciones de negocio, ver **Admin SP** en el mismo teamspace.
