...
- **audit_logs**: Log of relevant actions for traceability and support.
- **platform_settings**: Global configuration (feature flags, business parameters).

## Related

- [Architecture](architecture) — Technical stack and design
- [Database — Schema](../reference/database/schema) — Tables and relationships
- [Negotiation](../processes/negotiation) — Offer and closing flow
